...
exports.postSearchJournal = exports.postAddJournal = exports.getSearchJournalForm = exports.getJournal = exports.excelDownload = exports.editPatchComment = exports.downloadFile = exports.deleteJournal = exports.deleteComment = exports.customWeekJournal = exports.customJournal = exports.addPostComment = void 0;
var _menu = _interopRequireDefault(require("../schema/menu"));
var _journal = _interopRequireDefault(require("../schema/journal"));
...
var getJournal = exports.getJournal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var journal, now, dateMonth, order, menu, subMenu, auth, dep, _dep, color;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 34:
          ...
          return _context.abrupt("return", res.render("journal", {
  ...
  return function getJournal(_x, _x2) {
...
var postAddJournal = exports.postAddJournal = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, description, start, end, allDay, color, user, department, journal, fileId, filePath, strFileName, departmentInfo, singleFile, _singleFile$, originalname, mimetype, filename, path, size, file, userInfo;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          return _file["default"].create({
            ...
            path: path,
            size: size,
            dropboxUrl: "/journal/".concat(journal._id, "/").concat(originalname)
          });
        case 12:
          file = _context2.sent;
          fileId = file._id;
          (0, _middleware.dropbox)({
            ...
            parameters: {
              path: "/journal/".concat(journal._id, "/").concat(originalname)
            },
          ...
          _context2.next = 17;
          return _journal["default"].findByIdAndUpdate(journal._id, {
            file: file._id
          });
        case 17:
          _context2.next = 19;
  ...
  return function postAddJournal(_x3, _x4) {
...
var deleteJournal = exports.deleteJournal = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return _journal["default"].findByIdAndDelete(id);
        case 3:
  ...
  return function deleteJournal(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var customJournal = exports.customJournal = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var journal, _req$query, url, calendarDate, order, menuName, flag, flagTemp, menu, subMenu, auth, dep, color;
  ...
  return function customJournal(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var customWeekJournal = exports.customWeekJournal = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var journal, _req$query2, url, startDate, endDate, order, menuName, flag, now, flagTemp, menu, auth, dep, color;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          //url = req.url;
          //console.log(req);
          _req$query2 = req.query, url = _req$query2.url, startDate = _req$query2.startDate, endDate = _req$query2.endDate, order = _req$query2.order, menuName = _req$query2.menuName, flag = _req$query2.flag; //console.log(req.query);
          //console.log(url);
        ...
        case 10:
          ...
          _context6.next = 16;
          return _journal["default"].find(_defineProperty({
            department: dep,
            $or: [{
              start: {
                $gte: startDate
  ...
  return function customWeekJournal(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
var addPostComment = exports.addPostComment = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body2, commentText, journalId, user, userOJ, comment, journal;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _req$body2 = req.body, commentText = _req$body2.commentText, journalId = _req$body2.journalId, user = _req$body2.user;
          if (!commentText) {
            _context7.next = 16;
            break;
          }
        ...
        case 4:
          ...
          _context7.next = 7;
          return _journal["default"].findById(journalId);
        case 7:
          journal = _context7.sent;
          if (journal) {
            _context7.next = 10;
            break;
          }
        ...
        case 10:
          ...
          _pusher["default"].trigger(journal.user._id + "", journal.user._id + "", {
  ...
  return function addPostComment(_x13, _x14) {
    return _ref7.apply(this, arguments);
  };
}();
var editPatchComment = exports.editPatchComment = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var _req$body3, commentId, commentText, journalId, user, comment, userOJ;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          console.log(req.body);
          _req$body3 = req.body, commentId = _req$body3.commentId, commentText = _req$body3.commentText, journalId = _req$body3.journalId, user = _req$body3.user;
          _context8.next = 4;
  ...
  return function editPatchComment(_x15, _x16) {
...
var getSearchJournalForm = exports.getSearchJournalForm = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 2:
          partList = _context10.sent;
          return _context10.abrupt("return", res.render("searchJournal", {
            pageTitle: "일일업무조회",
            partList: partList
          }));
        case 4:
  ...
  return function getSearchJournalForm(_x19, _x20) {
    return _ref10.apply(this, arguments);
  };
}();
var postSearchJournal = exports.postSearchJournal = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var _req$body4, start, draw, length, startDate, endDate, userName, email, departmentId, journal, journalCount, user, searchParam;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 12:
          ...
          _context11.next = 15;
          return _journal["default"].find(searchParam).countDocuments().populate("department").populate("user");
        case 15:
          journalCount = _context11.sent;
          _context11.next = 18;
          return _journal["default"].find(searchParam).sort("-createdAt").skip(Number(start)).limit(Number(length)).populate("department").populate("user");
        case 18:
  ...
  return function postSearchJournal(_x21, _x22) {
    return _ref11.apply(this, arguments);
  };
}();
var excelDownload = exports.excelDownload = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(req, res) {
    var _req$body5, startDate, endDate, userName, email, departmentId, workbook, sheet, journal, user, searchParam, newRows;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 14:
          ...
          _context12.next = 17;
          return _journal["default"].find(searchParam).sort("-start -end").populate("department").populate("user");
        case 17:
          journal = _context12.sent;
          ...
          newRows = sheet.addRows(journal); //console.log(newRows);
          ...
          //   res.status(200).end();
          // });
          return _context12.abrupt("return", workbook.xlsx.writeFile("./excel/temp.xlsx").then(function () {
            //console.log('엑셀생성');
  ...
  return function excelDownload(_x23, _x24) {
