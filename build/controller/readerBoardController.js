...
exports.readerBoardListFileDownload = exports.readerBoardListDetailUpdate = exports.readerBoardListDetailDelete = exports.readerBoardListDetail = exports.getReaderBoardListForm = exports.getReaderBoardList = exports.addReaderBoardForm = exports.addReaderBoard = void 0;
...
var getReaderBoardListForm = exports.getReaderBoardListForm = function getReaderBoardListForm(req, res) {
  console.log("getReaderBoardListForm~~~~~~");
  return res.render("readerBoardList", {
    pageTitle: "공지사항"
  });
};
var getReaderBoardList = exports.getReaderBoardList = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, start, draw, length, searchTitle, readerBoarCount, readerBoard;
  ...
  return function getReaderBoardList(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var addReaderBoardForm = exports.addReaderBoardForm = function addReaderBoardForm(req, res) {
  return res.render("readerAdd", {
    pageTitle: "팀장공지 > 등록"
  });
};
var addReaderBoard = exports.addReaderBoard = /*#__PURE__*/function () {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          return _file["default"].create({
            ...
            path: path,
            size: size,
            dropboxUrl: "/readerBoard/".concat(boardId._id, "/").concat(originalname)
          });
        case 10:
          file = _context2.sent;
          (0, _middleware.dropbox)({
            ...
            parameters: {
              path: "/readerBoard/".concat(boardId._id, "/").concat(originalname)
            },
        ...
        case 14:
          if (publicYn === "Y") {
            console.log('pusher-----------');
            _pusher["default"].trigger("619de0b07987930016a4167f", "619de0b07987930016a4167f", {
              message: "새로운 팀장공지가 올라왔습니다. 확인해보세요!"
            });
          }
          return _context2.abrupt("return", res.redirect("/readerBoardList"));
        case 16:
        case "end":
  ...
  return function addReaderBoard(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var readerBoardListDetail = exports.readerBoardListDetail = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          console.log(reader);
          if (reader !== null && reader !== void 0 && reader.createdAt) {
            reader.createdAtFormat = (0, _moment["default"])(reader.createdAt).format("YYYY-MM-DD HH:mm:ss");
          }
          return _context3.abrupt("return", res.render("readerDetail", {
            pageTitle: "공지사항상세",
            reader: reader,
            id: id
          }));
  ...
  return function readerBoardListDetail(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
var readerBoardListDetailUpdate = exports.readerBoardListDetailUpdate = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 12:
          ...
          return _file["default"].create({
            ...
            path: path,
            size: size,
            dropboxUrl: "/readerBoard/".concat(boardId, "/").concat(originalname)
          });
        case 15:
          file = _context4.sent;
          (0, _middleware.dropbox)({
            resource: "files/upload",
            parameters: {
              path: "/readerBoard/".concat(boardId, "/").concat(originalname)
            },
            readStream: _fs["default"].createReadStream(path)
          }, function (err, result, response) {
            //upload completed
          ...
          notiUpdate.save();
        case 19:
          return _context4.abrupt("return", res.redirect("/readerBoardList"));
        case 20:
        case "end":
  ...
  return function readerBoardListDetailUpdate(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var readerBoardListDetailDelete = exports.readerBoardListDetailDelete = /*#__PURE__*/function () {
  ...
  return function readerBoardListDetailDelete(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var readerBoardListFileDownload = exports.readerBoardListFileDownload = /*#__PURE__*/function () {
  ...
  return function readerBoardListFileDownload(_x11, _x12) {
