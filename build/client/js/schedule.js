...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var calendar = new _core.Calendar(calendarEl, (_Calendar = {
    ...
    navLinks: true
  }, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_Calendar, "editable", true), "selectable", true), "nowIndicator", true), "dayMaxEvents", true), "locale", "ko"), "droppable", true), "dropAccept", ".drop-event"), "businessHours", {
    ...
    deleteflag = false;
  }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_Calendar, "select", function select(arg) {
  ...
  }), "resourceAreaHeaderContent", "Rooms"), "resources", [{
    id: "A",
    title: "국장님실 예약"
  }, {
    id: "B",
