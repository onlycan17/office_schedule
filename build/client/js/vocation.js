            ...
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                ...
                case 9:
                  ...
                  res.data.vocation.forEach(function (element) {
                ...
                case 22:
                  _res = _context4.sent;
                  console.log(_res.data.vocation);
                  _res.data.vocation.forEach(function (element) {
                    calendar.addEvent(element);
                  });
                  calendar.unselect();
                case 26:
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 22:
                  ...
                  console.log(_res2.data.vocation);
                  _res2.data.vocation.forEach(function (element) {
                    calendar.addEvent(element);
                  });
                  calendar.unselect();
                case 26:
      ...
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          if (res.status === 200) {
            ...
            param = temp.split("="); //location.href = `/vocation?order=${param[1]}`;
            location.replace("/vocation?order=".concat(param[1]));
