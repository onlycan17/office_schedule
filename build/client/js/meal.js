...
function createEditor() {
  _ckeditor5BuildClassic["default"].create(document.querySelector("#ckeditor"), {
    language: "ko",
            ...
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                ...
                case 9:
                  ...
                  res.data.meal.forEach(function (element) {
                ...
                case 22:
                  _res = _context4.sent;
                  console.log(_res.data.meal);
                  _res.data.meal.forEach(function (element) {
                    calendar.addEvent(element);
                  });
                  calendar.unselect();
                case 26:
            ...
            return _regeneratorRuntime().wrap(function _callee5$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 22:
                  ...
                  console.log(_res2.data.meal);
                  _res2.data.meal.forEach(function (element) {
                    calendar.addEvent(element);
                  });
                  calendar.unselect();
                case 26:
...
function _updateParam() {
  _updateParam = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id) {
    var resDel, element, formData, res;
      ...
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          if (res.status === 200) {
            ...
            param = temp.split("="); //location.href = `/meal?order=${param[1]}`;
            location.replace("/meal?order=".concat(param[1]));
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (url.indexOf("localhost") !== -1) {
          ...
          a.href = "https://master-piece-r.herokuapp.com/uploads/files/".concat(scheduleData[index].file.originalname);
        }
        // Set the file name
